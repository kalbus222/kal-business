...
const NavBar = () => {
  ...
  return (
    <nav className="fixed inset-x-0 top-0 z-100 px-4 md:px-12 py-4">
      <div className="relative mx-auto flex w-full max-w-7xl items-center justify-between gap-5">
        <div
          className={`z-10 aspect-square rounded-full border-[1.5px] border-accent frost p-5`}
        >
          <Link href="/">
            <Image
        ...
        >
              ...
              <div className="absolute left-auto hidden w-80 py-3 group-hover:block">
                <ul className="p-6 bg-primary text-white text-lg shadow-lg rounded-xl border-[1.5px] border-accent">
                  <li>
                    <a
                      href="/trading"
                      className="flex items-center justify-between group/link px-4 py-2"
                    >
                      General Trading
          ...
          {isMenuOpen && (
            <div
              className={`absolute z-4 top-15 left-0 right-0 rounded-b-2xl border-[1.5px] border-foreground w-full shadow-lg md:hidden bg-primary`}
            >
              <ul className="flex flex-col items-center space-y-4 py-4 font-mulish text-center">
                ...
                <li>
                  <a
                    href="/trading"
                    className="block px-4 py-2 text-white hover:text-accent transition-colors ease-in"
                  >
                    General Trading
                  </a>
                </li>
